  ...
  <div class="container-fluid">
    ...
    <div class="owl-carousel popuar-course-carusel">
      <div class="single-popular-course">
        <div class="thumb">
          <img class="f-img img-fluid mx-auto" src="view/img/popular-course/p1.jpg" alt="" />
        </div>
        <div class="details">
  ...
  <div class="row">
    <div class="col-xl-3 col-md-6 col-lg-3">
      <div class="single_team">
        <div class="thumb">
          <img src="view/img/team/1.png" alt="">
    ...
    <div class="col-xl-3 col-md-6 col-lg-3">
      <div class="single_team">
        <div class="thumb">
          <img src="view/img/team/3.png" alt="">
          <div class="social_link">
            <a href="#"><i class="fa fa-envelope"></i></a>
            <a href="#"><i class="fa fa-twitter"></i></a>
            <a href="#"><i class="fa fa-linkedin"></i></a>
    ...
    <div class="col-xl-3 col-md-6 col-lg-3">
      <div class="single_team">
        <div class="thumb">
          <img src="view/img/team/4.png" alt="">
          <div class="social_link">
            <a href="#"><i class="fa fa-envelope"></i></a>
            <a href="#"><i class="fa fa-twitter"></i></a>
            <a href="#"><i class="fa fa-linkedin"></i></a>
    ...
    <div class="testi-slider owl-carousel" data-slider-id="1">
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="item">
            <div class="testi-item">
              <img src="view/img/quote.png" alt="" />
        ...
        <div class="offset-lg-1 col-lg-6">
          <img src="view/img/testimonial/t1.jpg" alt="" />
        </div>
      </div>
    ...
    <div class="feature-inner row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="single-blog-post">
          <img src="view/img/blog-post/b1.jpg" class="img-fluid" alt="" />
      ...
      <div class="col-lg-4 col-md-6 mt--160">
        <div class="single-blog-post">
          <img src="view/img/blog-post/b2.jpg" class="img-fluid" alt="" />
          <div class="overlay"></div>
          <div class="top-text">
            <p>29th, oct, 2018</p>
            <p>121 likes</p>
      ...
      <div class="col-lg-4 col-md-6 mt--260">
        <div class="single-blog-post">
          <img src="view/img/blog-post/b3.jpg" class="img-fluid" alt="" />
          <div class="overlay"></div>
          <div class="top-text">
            <p>29th, oct, 2018</p>
            <p>121 likes</p>
